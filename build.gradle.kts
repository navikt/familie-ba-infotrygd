...
dependencies {
    ...
    implementation("no.nav.familie.kontrakter:felles:2.0_20210302142256_b10818b")
    implementation("no.nav.familie.kontrakter:barnetrygd:2.0_20210302142256_b10818b")
