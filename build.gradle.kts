...
dependencies {
    ...
    implementation("no.nav.familie.kontrakter:felles:2.0_20210312160913_1f140c8")
    implementation("no.nav.familie.kontrakter:barnetrygd:2.0_20210312160913_1f140c8")
