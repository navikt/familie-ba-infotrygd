...
dependencies {
    ...
    implementation("no.nav.familie.kontrakter:felles:2.0_20210303133941_2f9439f")
    implementation("no.nav.familie.kontrakter:barnetrygd:2.0_20210303133941_2f9439f")
