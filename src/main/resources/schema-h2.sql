...
(
    ...
    S05_GRUPPE VARCHAR2(2) , --NOT NULL,
    S05_BRUKERID VARCHAR2(7), -- NOT NULL,
    S05_MENGDETELLET CHAR(1), -- NOT NULL,
    ...
    REGION CHAR(1) DEFAULT ' ' , --NOT NULL,
    ID_SBLK NUMBER,
    OPPDATERT TIMESTAMP(6) DEFAULT localtimestamp,
...
create table INFOTRYGD_Q0.T_STONADSKLASSE (
    ...
    KODE_NIVAA                     VARCHAR2(2)    NOT NULL,
    KODE_KLASSE                    VARCHAR2(2)    NOT NULL,
...
CREATE TABLE INFOTRYGD_Q0.IP_PERSONKORT_90(
    IP01_PERSNKEY        VARCHAR2(7)   NOT NULL,
    ...
    IP90_TEKST           VARCHAR2(30)  NOT NULL,
    IP90_BEV_PROS        NUMBER(5,2),        -- NOT NULL
    IP90_BETALT_BELOEP   NUMBER(9,2),        -- NOT NULL
    IP90_GRUPPE          CHAR(1),       -- NOT NULL
    IP90_EIENDOM         CHAR(1),       -- NOT NULL
    IP90_EIENDOM_KODE    VARCHAR2(2),   -- NOT NULL
    IP90_OPPDAT_KODE     CHAR(1),       -- NOT NULL
    OPPRETTET            TIMESTAMP(6),       -- NOT NULL
    ENDRET_I_KILDE       TIMESTAMP(6),       -- NOT NULL
    KILDE_IS             VARCHAR2(12),  -- NOT NULL
...
CREATE TABLE INFOTRYGD_Q0.IP_PERSON_01(
    ...
    IP01_TKAVD              CHAR(1) , -- NOT NULL,
    IP01_DOEDSDATO          NUMBER(8) , -- NOT NULL,
    IP01_PENS_STAT          CHAR(1) , -- NOT NULL,
    IP01_SAK_STATUS         CHAR(1) , -- NOT NULL,
    IP01_STATBORGER         CHAR(1) , -- NOT NULL,
    IP01_EKTEF_PENSJ        CHAR(1) , -- NOT NULL,
    IP01_BARNE_PENSJ        CHAR(1) , -- NOT NULL,
    IP01_SP_STAT            CHAR(1) , -- NOT NULL,
    IP01_AL_STAT            CHAR(1) , -- NOT NULL,
    IP01_AF_STAT            CHAR(1) , -- NOT NULL,
    IP01_IN_STAT            CHAR(1) , -- NOT NULL,
    IP01_FORSIKR_STAT       CHAR(1) , -- NOT NULL,
    IP01_MAALFORM           CHAR(1) , -- NOT NULL,
    IP01_AVG_STAT           CHAR(1) , -- NOT NULL,
    IP01_BI_STAT            CHAR(1) , -- NOT NULL,
    IP01_DIV_STAT           CHAR(1) , -- NOT NULL,
    IP01_PERS_STATUS        CHAR(1) , -- NOT NULL,
    IP01_REG_KILDE          CHAR(1) , -- NOT NULL,
    IP01_FORS_DIFF          NUMBER(7) , -- NOT NULL,
    IP01_YTELSE             VARCHAR2(2) , -- NOT NULL,
    IP01_POBA_GIRO          NUMBER(11) , -- NOT NULL,
    IP01_SAK_TELLER         NUMBER(3) , -- NOT NULL,
    IP01_LEVEATTEST_UTGAATT CHAR(1) , -- NOT NULL,
    IP01_AKT_STAT           VARCHAR2(3) , -- NOT NULL,
    IP01_KJOENN             CHAR(1) , -- NOT NULL,
    IP01_SYSTAVD            CHAR(1) , -- NOT NULL,
    IP01_FNR_ENDRET         CHAR(1) , -- NOT NULL,
    IP01_BS_STAT            CHAR(1) , -- NOT NULL,
    IP01_FA_STAT            CHAR(1) , -- NOT NULL,
    IP01_RP_STAT            CHAR(1) , -- NOT NULL,
    TK_NR                   VARCHAR2(4) , -- NOT NULL,
    F_NR                    VARCHAR2(11) NOT NULL,
    OPPRETTET               TIMESTAMP(6) , -- NOT NULL,
    ENDRET_I_KILDE          TIMESTAMP(6) , -- NOT NULL,
...
, B01_BT_STATUS CHAR(1) -- NOT NULL
, B01_MOTTAKER_KODE VARCHAR2(3) -- NOT NULL
, B01_MOTTAKER_NR NUMBER(11, 0) -- NOT NULL
, B01_AKONTO_BELOP NUMBER(7, 0) -- NOT NULL
, B01_PENSJONSTRYGDET CHAR(1) -- NOT NULL
, TK_NR VARCHAR2(4) NOT NULL
, F_NR VARCHAR2(11) NOT NULL
, OPPRETTET TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, ENDRET_I_KILDE TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, KILDE_IS VARCHAR2(12) DEFAULT ' ' NOT NULL
, REGION CHAR(1) DEFAULT ' ' NOT NULL
, ID_BA_PERS NUMBER(15,0) DEFAULT NOT NULL
...
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
, B20_IVERFOM_SEQ VARCHAR2(6) /*NOT NULL*/
, B20_VIRKFOM_SEQ VARCHAR2(6) -- NOT NULL
, B20_GRUPPE VARCHAR2(2) -- NOT NULL
, B20_BRUKERID VARCHAR2(7) -- NOT NULL
, B20_TKNR VARCHAR2(4) -- NOT NULL
, B20_REG_DATO NUMBER(8, 0) -- NOT NULL
, B20_SOK_DATO NUMBER(8, 0) -- NOT NULL
, B20_BLOKK CHAR(1) -- NOT NULL
, B20_SAK_NR VARCHAR2(2) -- NOT NULL
, B20_STATUS VARCHAR2(2) -- NOT NULL
, B20_TEKSTKODE VARCHAR2(2) -- NOT NULL
, B20_EBET_FOM VARCHAR2(6) -- NOT NULL
, B20_EBET_TOM VARCHAR2(6) -- NOT NULL
, B20_OPPHOERT_IVER VARCHAR2(6) -- NOT NULL
, B20_OPPHORSGRUNN CHAR(1) -- NOT NULL
, B20_ANT_BARN NUMBER(2, 0) -- NOT NULL
, B20_OMREGN CHAR(1) -- NOT NULL
, B20_EOS CHAR(1) -- NOT NULL
, B20_EKSTRA_SMAB CHAR(1) -- NOT NULL
, B20_SVALBARD CHAR(1) -- NOT NULL
, B20_SAMBOERTYPE CHAR(1) -- NOT NULL
, B20_OPPHOERT_VFOM VARCHAR2(6) NOT NULL
, B20_ANT_SMAABARN NUMBER(2, 0) -- NOT NULL
, B20_DELT_OMS_PROS VARCHAR2(2) -- NOT NULL
, TK_NR VARCHAR2(4) NOT NULL
, F_NR VARCHAR2(11) NOT NULL
, OPPRETTET TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, ENDRET_I_KILDE TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, KILDE_IS VARCHAR2(12) DEFAULT ' ' NOT NULL
, REGION CHAR(1) DEFAULT ' ' NOT NULL
, ID_BA_STOENAD NUMBER DEFAULT NOT NULL
, OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
);
...
, B10_BA_IVER VARCHAR2(6) -- NOT NULL
, B10_BA_VFOM VARCHAR2(6) -- NOT NULL
, B10_BA_TOM VARCHAR2(6) NOT NULL
, B10_STONADS_TYPE VARCHAR2(2) -- NOT NULL
, TK_NR VARCHAR2(4) NOT NULL
, F_NR VARCHAR2(11) NOT NULL
, OPPRETTET TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, ENDRET_I_KILDE TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, KILDE_IS VARCHAR2(12) DEFAULT ' ' NOT NULL
, REGION CHAR(1) DEFAULT ' ' NOT NULL
, ID_BA_BARN NUMBER DEFAULT NOT NULL
, OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
);
...
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
, B30_START_UTBET_MND_SEQ VARCHAR2(6) NOT NULL
, B30_VFOM_SEQ VARCHAR2(6) NOT NULL
, B30_KONTONR VARCHAR2(8) NOT NULL
, B30_UTBET_TYPE CHAR(1) NOT NULL
, B30_GRUPPE VARCHAR2(2) -- NOT NULL
, B30_BRUKERID VARCHAR2(7) -- NOT NULL
, B30_UTBET_FOM VARCHAR2(6) -- NOT NULL
, B30_UTBET_TOM VARCHAR2(6) -- NOT NULL
, B30_UTBETALT CHAR(1) -- NOT NULL
, B30_BELOP NUMBER(7, 0) NOT NULL
, B30_UTBET_DATO NUMBER(8, 0) -- NOT NULL
, B30_KODE CHAR(1) -- NOT NULL
, TK_NR VARCHAR2(4) -- NOT NULL
, F_NR VARCHAR2(11) NOT NULL
, OPPRETTET TIMESTAMP(6) DEFAULT current_timestamp -- NOT NULL
, ENDRET_I_KILDE TIMESTAMP(6) DEFAULT current_timestamp -- NOT NULL
, KILDE_IS VARCHAR2(12) DEFAULT ' ' -- NOT NULL
, REGION CHAR(1) DEFAULT ' ' NOT NULL
, ID_BA_UTBET NUMBER DEFAULT NOT NULL
, OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp -- NOT NULL
);
...
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
, B40_UTBET_DATO_SEQ VARCHAR2(8) NOT NULL
, B40_NETTO_UTBET NUMBER(7, 0) NOT NULL
, B40_KORT_FRA VARCHAR2(10) NOT NULL
, B40_KORT_TIL VARCHAR2(10) NOT NULL
, B40_MOTTAKER_KODE VARCHAR2(3) NOT NULL
, B40_MOTTAKER_NR NUMBER(11, 0) NOT NULL
, B40_GIRONR VARCHAR2(11) NOT NULL
, B40_UTBET_KODE VARCHAR2(1) NOT NULL
, TK_NR VARCHAR2(4) NOT NULL
, F_NR VARCHAR2(11) NOT NULL
, OPPRETTET TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, ENDRET_I_KILDE TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
, KILDE_IS VARCHAR2(12) DEFAULT ' ' NOT NULL
, REGION CHAR(1) DEFAULT ' ' NOT NULL
, ID_BA_UTHIST NUMBER DEFAULT NOT NULL
, OPPDATERT TIMESTAMP(6) DEFAULT current_timestamp NOT NULL
);
...
, BRUKERID VARCHAR2(8) NOT NULL
, BARN_TYPE VARCHAR2(2)
...
(
  BESLUTNING_ID NUMBER NOT NULL
, VEDTAK_ID NUMBER NOT NULL
, SAKSBEHANDLER1 VARCHAR2(8) --NOT NULL
, GODKJENT1 CHAR(1) --NOT NULL
, ENHET1 VARCHAR2(4) --NOT NULL
, TIDSPUNKT_REG1 TIMESTAMP(6) --NOT NULL
, SAKSBEHANDLER2 VARCHAR2(8)
, GODKJENT2 CHAR(1)
, ENHET2 VARCHAR2(4)
