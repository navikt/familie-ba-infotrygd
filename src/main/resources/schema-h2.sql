...
Create table INFOTRYGD_Q0.IS_VEDTAK_BARN_18 (
    IS01_PERSONKEY                 NUMBER(15)          NOT NULL,
    IS18_ARBUFOER_SEQ              CHAR(8)             NOT NULL,
    IS18_KODE                      CHAR(1)             NOT NULL,
    IS18_ARBUFOER                  CHAR(8)             NOT NULL,
    IS18_STOENADS_TYPE             CHAR(2)             NOT NULL,
    IS18_STANS                     CHAR(8)             NOT NULL,
    IS18_FRISK                     CHAR(1)             NOT NULL,
    IS18_STILLINGSANDEL            CHAR(3)             NOT NULL,
    IS18_ARB_TIDS_PROS_GML         CHAR(2)             NOT NULL,
    IS18_TIDSK_PROS                NUMBER(4, 2)        NOT NULL,
    IS18_TIDSK_DAGER               CHAR(3)             NOT NULL,
    IS18_TIDSK_DAGER_FORB          CHAR(3)             NOT NULL,
    IS18_FOM                       CHAR(8)             NOT NULL,
    IS18_TOM                       CHAR(8)             NOT NULL,
    IS18_DEKNINGSGRAD              CHAR(3)             NOT NULL,
    IS18_TIDSK_DISPONIBELT         NUMBER(5, 2)        NOT NULL,
    IS18_TIDSK_HELE_DAGER_FORB     NUMBER(5, 2)        NOT NULL,
    IS18_STOENADSPERIODEN          CHAR(3)             NOT NULL,
    IS18_TIDSYK                    CHAR(3)             NOT NULL,
    IS18_FARFNR                    CHAR(11)            NOT NULL,
    IS18_MORFNR                    CHAR(11)            NOT NULL,
    IS18_TOT_TK_DAGER              CHAR(3)             NOT NULL,
    IS18_TOT_TK_DAGER_FORB         CHAR(3)             NOT NULL,
    IS18_TOT_HELE_TK_DAGER_FORB    NUMBER(5, 2)        NOT NULL,
    IS18_REG_DATO                  CHAR(8)             NOT NULL,
    IS18_TOT_DISPONIBELT           NUMBER(5, 2)        NOT NULL,
    IS18_KOMBI                     CHAR(1)             NOT NULL,
    IS18_FATOM                     CHAR(8)             NOT NULL,
