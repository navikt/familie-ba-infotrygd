...
CREATE TABLE INFOTRYGD_Q1.BA_PERSON_01
(
...
CREATE TABLE INFOTRYGD_Q1.BA_STOENAD_20
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
...
CREATE TABLE INFOTRYGD_Q1.BA_BARN_10
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
...
CREATE TABLE INFOTRYGD_Q1.BA_UTBETALING_30
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
...
CREATE TABLE INFOTRYGD_Q1.BA_UTBET_HIST_40
(
  B01_PERSONKEY NUMBER(15, 0) NOT NULL
...
CREATE TABLE INFOTRYGD_Q1.T_ENDRING
(
...
CREATE TABLE INFOTRYGD_Q1.T_ROLLE
(
  VEDTAK_ID NUMBER(*, 0) NOT NULL
...
CREATE TABLE INFOTRYGD_Q1.T_BESLUT
(
...
CREATE TABLE INFOTRYGD_Q1.T_TEKSTU
(
  BESLUTNING_ID NUMBER(*, 0) NOT NULL
, TEKSTLINJE NUMBER(*, 0)
