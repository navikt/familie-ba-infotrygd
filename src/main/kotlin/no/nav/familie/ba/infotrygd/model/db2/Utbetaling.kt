...
data class Utbetaling(
    ...
    fun fom(): YearMonth? = seqDatoTilYearMonth(virksomFom)

    fun tom(): YearMonth? = stringDatoMMyyyyTilYearMonth(utbetalingTom)

    fun erSmåbarnstillegg(): Boolean = this.kontonummer == "06040000"
}
